...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Mizlainaa = {}, global.jQuery));
    ...
    var DATA_KEY$e = 'inaa.cardrefresh';
    ...
    var DATA_KEY$d = 'inaa.cardwidget';
    ...
    var DATA_KEY$c = 'inaa.controlsidebar';
    ...
    var DATA_KEY$b = 'inaa.directchat';
    ...
    var DATA_KEY$9 = 'inaa.expandableTable';
    ...
    var DATA_KEY$8 = 'inaa.fullscreen';
    ...
    var IFrame = /*#__PURE__*/function () {
      ...
      IFrame._jQueryInterface = function _jQueryInterface(config) {
        if ($__default["default"](SELECTOR_DATA_TOGGLE$1).length > 0) {
          ...
          localStorage.setItem('Mizlainaa:IFrame:Options', JSON.stringify(_options));
          ...
          new IFrame($__default["default"](this), JSON.parse(localStorage.getItem('Mizlainaa:IFrame:Options')))._initFrameElement();
        }
      };
    ...
    var Layout = /*#__PURE__*/function () {
      ...
      _proto._init = function _init() {
        ...
        $__default["default"](SELECTOR_SIDEBAR$1).on('collapsed.inaa.treeview expanded.inaa.treeview', function () {
        ...
        $__default["default"](SELECTOR_PUSHMENU_BTN).on('collapsed.inaa.pushmenu shown.inaa.pushmenu', function () {
          setTimeout(function () {
            _this.fixLayoutHeight();
          }, 300);
        });
        $__default["default"](SELECTOR_CONTROL_SIDEBAR_BTN).on('collapsed.inaa.controlsidebar', function () {
          _this.fixLayoutHeight();
        }).on('expanded.inaa.controlsidebar', function () {
    ...
    var DATA_KEY$4 = 'inaa.sidebar-search';
    ...
    var DATA_KEY$3 = 'inaa.navbar-search';
  ...
  //# sourceMappingURL=.Mizlainaa.js.map
  //form validation
